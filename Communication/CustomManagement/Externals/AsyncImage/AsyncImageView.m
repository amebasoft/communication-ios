...
- (void)processDataInBackground:(NSData *)data
{
	...
	{	
		if (!self.cancelled)
		{
			...
			if (image)
			{
             // image=[self aspectScaleImage:image toSize:CGSizeMake(284, 139)];
...
- (UIImage *)aspectScaleImage:(UIImage *)image toSize:(CGSize)targetSize
{
...
- (void)setImageURL:(NSURL *)imageURL
{
    ...
    {
         self.image=[UIImage imageNamed:@"thrive_placeholder"];
...
#pragma mark- Set Image Size Methods
